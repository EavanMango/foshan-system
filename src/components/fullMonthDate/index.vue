<!--
 * @Description  : 横向排序时间组件
 * @Author       : 陈凯
 * @Date         : 2023-03-15 17:42:38
 * @LastEditors  : 陈凯
 * @LastEditTime : 2024-01-23 09:50:26
 * @FilePath     : \init-project\src\components\fullMonthDate\index.vue
-->
<template>
...
.calendarBox {
  ...
  margin: 10px 0;
  border-radius: 10px;
  // background-color: rgba(30, 81, 102, 0.7);
  overflow: hidden;
...
.calendarBox .first-day {
  position: absolute;
  top: 0;
  left: 0;
}

.calendarBox .first-day p {
  font-size: 12px;
  width: 54%;
  text-align: center;
  line-height: 16px;
...
.calendarBox .today .date-item-date {
  width: 100%;
  color: #870000;
}

.calendarBox .today-not-choosed {
  width: 28px;
  height: 28px;
  border-radius: 50%;
  margin: 6px;
...
.calendarBox .left-arrow,
.calendarBox .right-arrow {
  display: inline-block;
  box-sizing: border-box;
  vertical-align: top;
  width: 30px;
...
.calendarBox .left-arrow:hover,
.calendarBox .right-arrow:hover {
  @include background_color('primaryColor');
}
