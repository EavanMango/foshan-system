 ...
 * @LastEditors  : 陈凯
 * @LastEditTime : 2024-01-30 16:14:24
 * @FilePath     : \init-project\src\views\remote-control\components\controlTable.vue
-->
<template>
  <div id="base-table">
    <el-table
      ...
      >
        <template #default="{ row, column, $index }">
          ...
          <slot :name="columnV.prop" :rowData="{ row, $index }">
            ...
            <el-input
              v-show="
                row[column.property + 'Show'] && columnV.prop == 'downLoad'
              "
              :ref="column.property"
            ...
            <span
              ...
              :style="{
                color: columnV.textColor ? columnV.textColor : '',
              }"
            >
              {{
                columnV.formatter
